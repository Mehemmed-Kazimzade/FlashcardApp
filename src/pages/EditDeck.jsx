...
export default function EditDeck() {
    ...
    return <>
    <form onSubmit={(e) => handleSave(e, () => navigate("/decks/", {state: {status:"SUCCESS", message: "Deck updated successfully"}}))}>
        <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: 900, mx: 'auto' }}>
            <Paper elevation={3} sx={{ p: { xs: 2, md: 4 }, borderRadius: 3, ml: 4 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1 }} className="editDeckButtonContainer">
                    <Button variant="outlined" fullWidth={true} sx={{ maxWidth: "200px" }} color="error">Cancel</Button>
                    <Button variant="contained" startIcon={<SaveIcon />} fullWidth={true} sx={{ maxWidth: "200px" }} type="submit">
                        Save Changes
                    </Button>
                </Box>
            </Paper>
